...
# TODO explore multitask beta likelihood
# TODO verify this implementation towards PV outputs
...
class VariationalLFM(LFM, ABC):
    ...
    Args:
        ...
        fixed_variance (torch.Tensor): variance if the preprocessing variance is known
