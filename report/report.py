...
if __name__ == '__main__':
    ...
    x_list, y_list = utils.cross_val_fold(X, y, N_DAYS_TRAIN, DAILY_DATA_POINTS)
    x_train, y_train, x_test, y_test =  utils.train_test_split_fold(x_list, y_list, N_HOURS_PRED, DAILY_DATA_POINTS, DAY_MIN, DAY_MAX)
